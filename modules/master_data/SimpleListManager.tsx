                  ...
                  {showDocTypeConfig && (
                     <div className="pt-2">
                        ...
                        <div className="grid grid-cols-2 gap-4 bg-blue-50/50 dark:bg-blue-900/10 p-3 rounded-lg border border-blue-100 dark:border-blue-900/30">
                           ...
                           <div className="col-span-2"><p className="text-[11px] text-gray-500 italic">Ví dụ: Nếu tài liệu cha là <span className="font-bold">P06</span>, Prefix là <span className="font-bold">QT</span> -> Mã con sẽ là <span className="font-bold">P06.QT01</span></p></div>
                        </div>
                     </div>
                  )}
