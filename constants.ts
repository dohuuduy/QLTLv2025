...
export const INITIAL_MASTER_DATA: MasterDataState = {
  ...
  linhVuc: [
    ...
    { id: '3', ten: "Sản xuất", active: true, thu_tu: 3 },
    { id: '4', ten: "Kinh doanh & Marketing", active: true, thu_tu: 4 },
    { id: '5', ten: "Hệ thống quản lý (ISO)", active: true, thu_tu: 5 },
  ],
  boPhan: [
...
export const MOCK_TAI_LIEU: TaiLieu[] = [
  {
    ...
    id_loai_tai_lieu: '1', // Quy trình
    id_linh_vuc: '1', // HCNS
    id_tieu_chuan: ['1'], // ISO 9001
    thu_tu: 10,
    phien_ban: '3.0',
    lan_ban_hanh: 3,
  ...
  },
  {
    ...
    id_loai_tai_lieu: '2',
    id_linh_vuc: '3',
    id_tieu_chuan: ['2', '3'], // ISO 14001, 45001
    thu_tu: 20,
    phien_ban: '1.0',
    lan_ban_hanh: 1,
